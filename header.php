	...
	?>
                ...
                <!--Sidebar Navigation-->
                    <div class="col-md-5 hidden-sm hidden-xs" id = "logo_fixed" >
                        <img src = "Images/Banner/shopping.png" id = "picture_logo">
                    </div>
                    <div class="col-md-7" >
                        <center>
                            <h1 id = "header_txt"><font class = "FS">F</font>ashion <font class = "FS">S</font>hop</h1>
                            <p id = "header_txt_trends">Latest Trends In Fashion</p>
                        </center>
                        
                        <div id = 'welcome'>
                            <ul>
                            <li>Welcome,</li>
                            <li><?php if (isset($_SESSION['SID'])){echo "$sid";} ?></li>
                            </ul>
                        </div>
                    </div>
            </div>
